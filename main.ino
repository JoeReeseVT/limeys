 ...
 *  
 * Purpose: This code is to control a small "Swarmbot" consisting of DC
 *     motors, photosensors, hall effect sensors, collision detection 
 *     switches, and a 2 MHz radio communication system.
 * 
 * Notes:
...
/* Use complier optimization for speed */
